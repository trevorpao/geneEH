...
let gene = {
    ...
    stdSubmit: function (me) {
        let form = me.dataset.ta ? document.getElementById(me.dataset.ta) : utils.closest(me, 'form');
        ...
        let inputs = utils.find(me, 'input');
        ...
        if (!$.validatr.validateForm(form)) {
            ...
            utils.append(me, '<i class="fa fa-spinner fa-pulse fa-fw"></i>');
            gene.yell(me.dataset.uri, utils.serialize(form), dAction, dAction);
        }
    },
    ...
    load: function (functionName) {
        ...
        if (!gene.check(functionName)) {
            if (typeof importScripts == 'function') {
                ...
                gene.clog('This website requires a more modern browser.');
            }
        }
    },
    ...
    init: function (element) {
        ...
        element.querySelectorAll('.' + gene.taClass).each(function () {
            let me = this,
                e = me.dataset.event,
                b = me.dataset.behavior,
                ebi = me.dataset.gene,
                meb = {};
            if (!gene.isset(b)) {
                b = 'notfound';
